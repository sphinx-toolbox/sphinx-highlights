...
The ``sphinx-highlights`` source code is available on GitHub,
...
The recommended way to build ``sphinx-highlights`` is to use `tox <https://tox.readthedocs.io/en/latest/>`_:
