...
rst_prolog = f""".. |pkgname| replace:: sphinx-highlights
.. |pkgname2| replace:: ``sphinx-highlights``
.. |browse_github| replace:: `Browse the GitHub Repository <{github_url}>`__
"""

author = "Dominic Davis-Foster"
project = "sphinx-highlights".replace('_', '-')
...
documentation_summary = "Sphinx extension to display a selection of highlights from a Python library."
